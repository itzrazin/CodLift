...
const BlogCard = ({ post }) => (
  ...
  >
    <Link to={`/blog/${post.slug}`}>
      <GlassCard className="h-full flex flex-col p-6 hover:border-cyan/30 transition-colors" hover={true}>
        ...
        <h3 className="text-2xl font-syne font-extrabold mb-3 group-hover:text-cyan transition-colors line-clamp-2">
          {post.title}
        </h3>
        ...
        <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
          ...
          <div className="text-cyan text-xs font-bold flex items-center gap-1 group-hover:translate-x-1 transition-transform">
        ...
        <div className="container mx-auto max-w-6xl">
          <header className="text-center mb-20">
            ...
            <h1 className="text-5xl md:text-7xl font-syne font-extrabold tracking-tight mb-8">
              The <span className="text-gradient-cyan">CodLift</span> Blog
            </h1>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
                <input 
                  ...
                  className="flex-1 bg-navy/50 border border-white/5 rounded-2xl px-6 py-4 focus:outline-none focus:border-cyan/50"
                />
                <Button className="px-8 rounded-2xl">Subscribe</Button>
              </div>
            </div>
            <div className="absolute top-0 right-0 w-64 h-64 bg-cyan/5 blur-[100px] rounded-full" />
          </GlassCard>
        </div>
      </main>
