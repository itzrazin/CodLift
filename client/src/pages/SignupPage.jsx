...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await signup(username.trim(), email.trim().toLowerCase(), username.trim(), password);
      navigate('/dashboard');
    } catch (err) {
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="glass rounded-3xl p-8 border border-white/10">
            <div className="mb-7">
              <h1 className="text-3xl font-syne font-extrabold mb-1">Create account</h1>
              <p className="text-gray-400 text-sm">100% free — forever.</p>
            </div>
